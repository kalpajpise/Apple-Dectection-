...
apple2=cv2.imread('5.jpg')
banana=cv2.imread('2.jpg')
strawberry=cv2.imread('3.jpg')
fruit=cv2.imread('4.jpg')
#process image
result_apple=draw_apple(apple)
result_apple2=draw_apple(apple2)
...
cv2.imwrite('it_is_apple.jpg',result_apple)
cv2.imwrite('it_is_apple(2).jpg',result_apple2	)
cv2.imwrite('it_is_banana.jpg',result_banana)
cv2.imwrite('it_is_strawberry.jpg',result_strawberry)
cv2.imwrite('multiplefruits.jpg',result_fruit)
